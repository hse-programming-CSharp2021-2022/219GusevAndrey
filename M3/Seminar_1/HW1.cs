...
namespace HW1
{
    class Program
    {
        ...
        public static int C1(double x) => (int) (x / 2) * 2;

        public static int C2(double x) => (int) (Math.Log10(x)) + 1;

        static void Main(string[] args)
        {
            Cast cast1 = delegate(double x) => (int) (x % 2) == 0 ? (int) x : (int) x + 1;
            Cast cast2 = (x) => (int) (Math.Log10(x)) + 1;
            
            Console.WriteLine(cast1(123.7));
            Console.WriteLine(cast2(12.5)); 
            Console.WriteLine();
            ...
            Console.WriteLine(cast3?.Invoke(114.2));
            Console.WriteLine();
            ...
            Console.WriteLine(cast6?.Invoke(16.7)); 
            Console.WriteLine();
